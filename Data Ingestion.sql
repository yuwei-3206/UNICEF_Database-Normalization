...
DROP TABLE UDW_FACT_NUTRITION CASCADE CONSTRAINTS;
DROP TABLE UDW_FACT_DEATH CASCADE CONSTRAINTS;
DROP TABLE UDW_FACT_EDUCATION CASCADE CONSTRAINTS;
DROP TABLE UDW_FACT_POPULATION CASCADE CONSTRAINTS;
DROP TABLE UDW_DIM_TIME CASCADE CONSTRAINTS;
DROP TABLE UDW_DIM_GENDER CASCADE CONSTRAINTS;
DROP TABLE UDW_DIM_COUNTRY CASCADE CONSTRAINTS;
...
-- Table: UDW_FACT_DEATH
CREATE TABLE UDW_FACT_DEATH (
    YEAR_CODE integer  NOT NULL,
    GENDER_CODE char(1)  NOT NULL,
    COUNTRY_CODE char(3)  NOT NULL,
    CME_TMY0 integer  NULL,
    CME_TMY0T4 integer  NULL,
    CME_TMY10T14 integer  NULL,
    CME_TMY10T19 integer  NULL,
    CME_TMY15T19 integer  NULL,
    CME_TMY5T9 integer  NULL,
    CME_TMY1T4 integer  NULL,
    CME_TMY20T24 integer  NULL,
    CME_TMY5T14 integer  NULL,
    CME_TMY5T24 integer  NULL,
    CME_TMY15T24 integer  NULL,
    CONSTRAINT UDW_FACT_DEATH_pk PRIMARY KEY (YEAR_CODE,GENDER_CODE,COUNTRY_CODE)
) ;

-- Table: UDW_FACT_EDUCATION
CREATE TABLE UDW_FACT_EDUCATION (
    YEAR_CODE integer  NOT NULL,
    GENDER_CODE char(1)  NOT NULL,
    COUNTRY_CODE char(3)  NOT NULL,
    ED_15_24_LR number(10,6)  NULL,
    ED_ANAR_L02 number(10,6)  NULL,
    ED_ANAR_L1 number(10,6)  NULL,
    ED_ANAR_L2 number(10,6)  NULL,
    ED_ANAR_L3 number(10,6)  NULL,
    ED_CR_L1 number(10,6)  NULL,
    ED_CR_L2 number(10,6)  NULL,
    ED_CR_L3 number(10,6)  NULL,
    ED_MAT_G23 number(10,6)  NULL,
    ED_MAT_L1 number(10,6)  NULL,
    ED_MAT_L2 number(10,6)  NULL,
    ED_READ_G23 number(10,6)  NULL,
    ED_READ_L1 number(10,6)  NULL,
    ED_READ_L2 number(10,6)  NULL,
    ED_ROFST_L02 number(10,6)  NULL,
    ED_ROFST_L1 number(10,6)  NULL,
    ED_ROFST_L1_ADM number(10,6)  NULL,
    ED_ROFST_L2 number(10,6)  NULL,
    ED_ROFST_L2_ADM number(10,6)  NULL,
    ED_ROFST_L3 number(10,6)  NULL,
    ED_ROFST_L3_ADM number(10,6)  NULL,
    CONSTRAINT UDW_FACT_EDUCATION_pk PRIMARY KEY (GENDER_CODE,YEAR_CODE,COUNTRY_CODE)
) ;

-- Table: UDW_FACT_NUTRITION
CREATE TABLE UDW_FACT_NUTRITION (
    YEAR_CODE integer  NOT NULL,
    GENDER_CODE char(1)  NOT NULL,
    COUNTRY_CODE char(3)  NOT NULL,
    NT_CF_ASF number(10,6)  NULL,
    NT_CF_BREASTMILK number(10,6)  NULL,
    NT_CF_DAIRY number(10,6)  NULL,
    NT_CF_EGGS number(10,6)  NULL,
    NT_CF_FF number(10,6)  NULL,
    NT_CF_GRAINS number(10,6)  NULL,
    NT_CF_ISSSF_FL number(10,6)  NULL,
    NT_CF_LEGUMES number(10,6)  NULL,
    NT_CF_MAD number(10,6)  NULL,
    NT_CF_MDD number(10,6)  NULL,
    NT_CF_MMF number(10,6)  NULL,
    NT_CF_OTHER_FV number(10,6)  NULL,
    NT_CF_VITA number(10,6)  NULL,
    NT_CF_ZEROFV number(10,6)  NULL,
    CONSTRAINT UDW_FACT_NUTRITION_pk PRIMARY KEY (YEAR_CODE,GENDER_CODE,COUNTRY_CODE)
) ;
...
-- foreign keys
-- Reference: FACT_EDUCATION_GENDER (table: UDW_FACT_EDUCATION)
ALTER TABLE UDW_FACT_EDUCATION ADD CONSTRAINT FACT_EDUCATION_GENDER
    FOREIGN KEY (GENDER_CODE)
    REFERENCES UDW_DIM_GENDER (GENDER_CODE);

-- Reference: UDW_DIM_COUNTRY_FACT_POP_FK (table: UDW_FACT_POPULATION)
ALTER TABLE UDW_FACT_POPULATION ADD CONSTRAINT UDW_DIM_COUNTRY_FACT_POP_FK
    FOREIGN KEY (COUNTRY_CODE)
    REFERENCES UDW_DIM_COUNTRY (COUNTRY_CODE);

-- Reference: UDW_DIM_GENDER_FACT_POP_FK (table: UDW_FACT_POPULATION)
ALTER TABLE UDW_FACT_POPULATION ADD CONSTRAINT UDW_DIM_GENDER_FACT_POP_FK
    FOREIGN KEY (GENDER_CODE)
    REFERENCES UDW_DIM_GENDER (GENDER_CODE);

-- Reference: UDW_DIM_TIME_FACT_POP_FK (table: UDW_FACT_POPULATION)
...
-- Reference: UDW_FACT_DEATH_UDW_DIM_COUNTRY (table: UDW_FACT_DEATH)
ALTER TABLE UDW_FACT_DEATH ADD CONSTRAINT UDW_FACT_DEATH_UDW_DIM_COUNTRY
    FOREIGN KEY (COUNTRY_CODE)
    REFERENCES UDW_DIM_COUNTRY (COUNTRY_CODE);

-- Reference: UDW_FACT_DEATH_UDW_DIM_GENDER (table: UDW_FACT_DEATH)
ALTER TABLE UDW_FACT_DEATH ADD CONSTRAINT UDW_FACT_DEATH_UDW_DIM_GENDER
    FOREIGN KEY (GENDER_CODE)
    REFERENCES UDW_DIM_GENDER (GENDER_CODE);

-- Reference: UDW_FACT_DEATH_UDW_DIM_TIME (table: UDW_FACT_DEATH)
ALTER TABLE UDW_FACT_DEATH ADD CONSTRAINT UDW_FACT_DEATH_UDW_DIM_TIME
    FOREIGN KEY (YEAR_CODE)
    REFERENCES UDW_DIM_TIME (YEAR_CODE);

-- Reference: UDW_FACT_EDUCATION_COUNTRY (table: UDW_FACT_EDUCATION)
ALTER TABLE UDW_FACT_EDUCATION ADD CONSTRAINT UDW_FACT_EDUCATION_COUNTRY
    FOREIGN KEY (COUNTRY_CODE)
    REFERENCES UDW_DIM_COUNTRY (COUNTRY_CODE);

-- Reference: UDW_FACT_EDUCATION_TIME (table: UDW_FACT_EDUCATION)
ALTER TABLE UDW_FACT_EDUCATION ADD CONSTRAINT UDW_FACT_EDUCATION_TIME
    FOREIGN KEY (YEAR_CODE)
    REFERENCES UDW_DIM_TIME (YEAR_CODE);

-- Reference: UDW_FACT_NUTRITION_COUNTRY (table: UDW_FACT_NUTRITION)
ALTER TABLE UDW_FACT_NUTRITION ADD CONSTRAINT UDW_FACT_NUTRITION_COUNTRY
    FOREIGN KEY (COUNTRY_CODE)
    REFERENCES UDW_DIM_COUNTRY (COUNTRY_CODE);

-- Reference: UDW_FACT_NUTRITION_GENDER (table: UDW_FACT_NUTRITION)
ALTER TABLE UDW_FACT_NUTRITION ADD CONSTRAINT UDW_FACT_NUTRITION_GENDER
    FOREIGN KEY (GENDER_CODE)
    REFERENCES UDW_DIM_GENDER (GENDER_CODE);

-- Reference: UDW_FACT_NUTRITION_TIME (table: UDW_FACT_NUTRITION)
ALTER TABLE UDW_FACT_NUTRITION ADD CONSTRAINT UDW_FACT_NUTRITION_TIME
    FOREIGN KEY (YEAR_CODE)
    REFERENCES UDW_DIM_TIME (YEAR_CODE);
...
-- For checking
SELECT * FROM hc848.UNICEF_RAW_DATA;

SELECT * FROM UDW_FACT_NUTRITIO;
SELECT * FROM UDW_FACT_DEATH;
SELECT * FROM UDW_FACT_EDUCATION;
SELECT * FROM UDW_FACT_POPULATION;
SELECT * FROM UDW_DIM_TIME;
SELECT * FROM UDW_DIM_GENDER;
SELECT * FROM UDW_DIM_COUNTRY;

DELETE UDW_FACT_NUTRITIO;
DELETE UDW_FACT_DEATH;
DELETE UDW_FACT_EDUCATION;
DELETE UDW_FACT_POPULATION;
DELETE UDW_DIM_TIME;
DELETE UDW_DIM_GENDER;
DELETE UDW_DIM_COUNTRY;

SELECT DISTINCT INDICATOR FROM hc848.UNICEF_RAW_DATA WHERE INDICATOR LIKE 'NT_CF%'; -- 14 indicators
SELECT DISTINCT INDICATOR FROM hc848.UNICEF_RAW_DATA WHERE INDICATOR LIKE 'ED%'; -- 21 indicators
SELECT DISTINCT INDICATOR FROM hc848.UNICEF_RAW_DATA WHERE INDICATOR LIKE 'CME_TMY%'; -- 11 indicators
SELECT DISTINCT INDICATOR FROM hc848.UNICEF_RAW_DATA WHERE INDICATOR LIKE 'DM_POP%'; -- 9 indicators
